...
import Azure from "../../assets/buma.png";
      ...
      <Stack horizontal className={styles.chatRoot} >
          ...
          {!lastQuestionRef.current ? (
            <Stack className={styles.chatEmptyState}>
              ...
              {assistantType === 'contract assistant' ? (
                ...
                <>
                  <h1 className={styles.chatEmptyStateTitle}>Selamat datang di BUMA AI</h1>
                  <h2 className={styles.chatEmptyStateSubtitle}>BUMA AI siap membantu memenuhi permintaan anda.</h2>
                </>
        ...
        {answers.length > 0 && isCitationPanelOpen && activeCitation && (
          <Stack.Item className={`${styles.citationPanel} ${styles.mobileStyles}`}>
            ...
            <div className={`${styles.citationPanelDisclaimer} ${styles.mobileCitationPanelDisclaimer}`}>Tekan link untuk membuka dokumen asli.</div>
            <ReactMarkdown
